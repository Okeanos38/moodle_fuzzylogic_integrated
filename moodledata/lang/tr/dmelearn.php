...
/**
 * Strings for component 'dmelearn', language 'tr', version '3.10'.
 *
 * @package     dmelearn
 * @category    string
...
$string['dmelearncoursepath'] = 'Digital Media e-Öğrenme Dersi';
...
$string['mfnocourses'] = '<style>.mf-info{color: # e32f0b; font-weight: bold;} </ style><div><span class = "mf-info">Bilgi:</ span>DM e-Learning sunucusu Mevcut kursları iade etmeyin. Lütfen yardım için  Digital Media ile iletişime geçin.</div><br>';
...
$string['startoredit'] = 'Digital Media e-Öğrenme girişimi başlat veya düzenle';

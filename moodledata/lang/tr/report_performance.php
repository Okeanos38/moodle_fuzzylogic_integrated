...
/**
 * Strings for component 'report_performance', language 'tr', version '3.10'.
 *
...
$string['check_backup_details'] = 'Otomatik yedeklemenin etkinleştirilmesi otomatik olarak belirttiğiniz zamanda sunucudaki tüm derslerin arşivleri oluşturacak. <p> Bu süreçte, daha fazla sunucu kaynaklarını tüketeceğini ve performansı olumsuz etkileyeceğini unutmayın. </p>';
...
$string['check_debugmsg_comment_developer'] = 'Eğer GELİŞTİRİCİ olarak ayarlarsanız performansı biraz arttırmış olursunuz.';

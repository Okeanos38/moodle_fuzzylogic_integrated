...
/**
 * Strings for component 'tool_filetypes', language 'tr', version '3.10'.
 *
...
$string['description_help'] = 'Basit dosya türü açıklaması, ör. &Lsquo; Kindle ebook &rsquo ;; Siteniz birden çok dili destekliyorsa ve çok dilli filtreyi kullanıyorsa, farklı dillerde bir açıklama sağlamak için bu alanda çoklu dil etiketleri girebilirsiniz.';
...
$string['extension_help'] = 'Nokta olmadan dosya uzandısı örn  &lsquo;mobi&rsquo;';
$string['groups'] = 'Tür grupları';
$string['groups_help'] = 'Bu türün ait olduğu dosya türü gruplarının isteğe bağlı listesi. Bunlar, &lsquo;document&rsquo; gibi genel kategorilerdir; Ve &lsquo;image&rsquo;.';
...
$string['mimetype_help'] = 'Bu dosya türüne bağlı MIME türü, ör. &lsquo; uygulama/x-mobipocket-ebook&rsquo;';

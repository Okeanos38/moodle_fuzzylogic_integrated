...
/**
 * Strings for component 'block_configurable_reports', language 'tr', version '3.10'.
 *
...
$string['comp_customsql_help'] = '<p> Çalışyşan bir SQL sorgusu ekleyiniz. Moodle veritabanında kullandığınız tablo öneklerini kullanmayınız.  $CFG->prefix yerine  "prefix_ kullanınız. " tırnak işareti olmadan"  </p>
...
<p>SQL Roporunda kullanabileceğiniz süzgeç türleri için bkz:  <a href="http://docs.moodle.org/en/blocks/configurable_reports/#Creating_a_SQL_Report" target="_blank">SQL Raporu Oluşturma Dersi</a></p>
...
$string['currentuserfinalgrade'] = 'Geçerli kullanıcının dersteki nihayi notu';
$string['currentuserfinalgrade_summary'] = 'Bu sütun geçerli kullanıcının satırdaki dersteki nihai notunu  gösterir.';
...
$string['finalgradeincurrentcourse'] = 'Gerçerli kursun final notu';
...
$string['report_courses'] = 'Kursların raporu';

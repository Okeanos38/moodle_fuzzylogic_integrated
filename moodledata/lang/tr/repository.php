...
/**
 * Strings for component 'repository', language 'tr', version '3.10'.
 *
 * @package     repository
 * @category    string
...
$string['activerepository'] = 'Uygun depo eklentileri';
$string['activitybackup'] = 'Faaliyet yedeği';
$string['add'] = 'Ekle';
$string['addfile'] = 'Ekle...';
...
$string['areacourseoverviewfiles'] = 'Ders özeti dosyaları';
...
$string['backtodraftfiles'] = '&laquo; Taslak dosya yöneticisine geri dön';
...
$string['confirmrenamefile'] = 'Bu dosyayı yeniden adlandırmak/taşımak istediğinizden emin misiniz? Bu dosyayı kaynak olarak kullanan {$a} takma ad/kısayol dosyaları var. Devam ederseniz, bu takma adlar gerçek kopyalara dönüştürülecektir.';
$string['confirmrenamefolder'] = 'Bu klasörü taşımak/yeniden adlandırmak istediğinizden emin misiniz? Bu klasördeki dosyalara referans veren tüm takma ad/kısayol dosyaları gerçek kopyalara dönüştürülecektir.';
$string['continueuninstall'] = 'Devam et';
$string['continueuninstallanddownload'] = 'Devam et ve indir';
$string['copying'] = 'Kopyalanıyor';
$string['coursebackup'] = 'Ders yedekleri';
...
$string['instancesforcourses'] = '{$a} Ders çapında yaygın örnek(ler)';
...
$string['makefilereference'] = 'Dosyaya bir takma ad/kısayol oluşturma';
...
$string['referencesexist'] = 'Bu dosyayı kaynak olarak kullanan {$a} tane takma ad/kısayol dosyaları var';
$string['referenceslist'] = 'Takma adlar/Kısayollar';

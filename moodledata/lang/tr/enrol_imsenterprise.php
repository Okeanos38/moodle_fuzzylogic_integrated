...
/**
 * Strings for component 'enrol_imsenterprise', language 'tr', version '3.10'.
 *
...
$string['createnewcategories_desc'] = 'Bir dersin gelen verilerinde <org> <orgunit> öğesi mevcut ise, dersin sıfırdan oluşturulması durumunda içeriği bir kategori belirlemek için kullanılacaktır. Eklenti mevcut dersleri yeniden sınıflandırmayacaktır.

İstediğiniz ismi içeren kategori yoksa, gizli bir kategori oluşturulacaktır.';
$string['createnewcourses'] = 'Moodle\'da yok ise yeni (gizli) ders oluştur';
$string['createnewcourses_desc'] = 'Etkinleştirildiğinde, IMS Enterprise kayıt eklentisi, IMS verilerinde bulan herhangi biri için yeni dersler oluşturabilir, ancak Moodle\'ın veritabanında bulunmayabilir. Yeni oluşturulan dersler başlangıçta gizlenir.';
$string['createnewusers'] = 'Moodle\'da kayıtlı olmayan kullanıcıların hesaplarını oluştur';
$string['createnewusers_desc'] = 'IMS Enterprise kayıt verileri genellikle bir dizi kullanıcıyı tanımlar. Etkinleştirilirse, Moodle\'ın veritabanında bulunmayan tüm kullanıcılar için hesaplar oluşturulabilir.

Kullanıcılar önce "idnumber" larıyla, ikinci sırada Moodle kullanıcı adlarıyla aranırlar. Şifreler, IMS Enterprise eklentisi tarafından alınmaz. Kullanıcıların kimliğini doğrulamak için bir kimlik doğrulama eklentisi kullanılması önerilir.';
...
$string['settingshortname'] = 'Dersin kısa adı için IMS açıklama etiketi';
...
$string['settingsummarydescription'] = 'İsteğe bağlı bir alansa, ders özetini belirtmek istemiyorsanız \'Boş bırak\' seçeneğini belirleyin';
...
$string['updatecourses'] = 'Dersi güncelle';

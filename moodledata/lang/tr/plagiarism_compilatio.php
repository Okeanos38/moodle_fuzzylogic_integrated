...
/**
 * Strings for component 'plagiarism_compilatio', language 'tr', version '3.10'.
 *
...
$string['account_expire_soon_content'] = 'Compilatio\' yu ay sonuna kadar kullanabilirsiniz. Aboneliğiniz yenilenmezse, bu tarihten sonra Derleme hizmetlerini kullanamazsınız.';
...
$string['analysis_completed'] = 'Analiz tamamlandı: benzerliklerden {$ a}%.';
$string['analysis_date'] = 'Analiz Tarihi (Sadece süreli analiz)';
$string['analysis_started'] = '{$a} analiz talep edildi.';
$string['analysis_type'] = 'Analizi başlat';
$string['analysis_type_help'] = '<p>3 olası seçenek vardır:</p>
<ul>
	<li><strong>Doğrudan: </strong>Belge Compilatio\' ya gönderilir ve hemen analiz edilir.</li>
	<li><strong>El ile:</strong> Belge Compilatio\' ya gönderilir, ancak öğretmenin belgelerin analizini elle tetiklemesi gerekir.</li>
	<li><strong>Süreli: </strong> Belge, saat/tarih setinde Derleme ve analiz bölümüne gönderilir.</li>
</ul>
<p>Tüm belgelerin birbirleriyle karşılaştırılmasını sağlamak için, tüm çalışmalar öğrenciler tarafından gönderilene kadar bekleyin ve ardından analiz tetiklenir.</p>';
$string['analysistype_direct'] = 'Doğrudan';
...
$string['compilatio_draft_submit'] = 'Dosya Compilatio\' ya ne zaman sunulmalıdır?';
...
$string['export_csv'] = 'Bu ödev ile ilgili verileri bir CSV dosyasına aktarın';
...
.';
$string['help_compilatio_settings_content'] = 'Compilatio eklentisi ile üç analiz türü mevcuttur:
<ul>
<li>
Doğrudan : <br/>
Her bir belge Compilatio\'ya gönderilir ve öğrencinin yüklemesi üzerine analiz edilir. <br/>
Sonuçları hızlı bir şekilde almak isterseniz ve tüm belgelerin birbirleriyle karşılaştırılmasına gerek yoksa önerilir.
</li>
<li>
Süreli : <br/>
Compilatio analizine başlamak için, öğrenciler için son tarihin ilerisindeki tarih seçin. <br/>
Karşılıklı etkinliğin tüm belgelerini karşılaştırmak isterseniz önerilir.
</li>
<li>
El ile : <br/>
Etkinliğin belgeleri, analiz tetiklenene kadar analiz edilmez. <br/>
Analizini tetiklemek için her belgenin "Analiz işlemine başla" düğmesine basabilirsiniz.
</li>
</ul>';
$string['help_compilatio_settings_title'] = 'Bir etkinliğin Compilatio ayarlarında hangi modu kullanmalıyım?';
...
$string['not_analyzed_unextractable'] = 'Yeterli metin içermediğinden {$ a} belge(ler) analiz edilmedi.';
$string['not_analyzed_unsupported'] = 'Biçimleri desteklenmediği için {$ a} belge(ler) analiz edilmemiştir.';
...
$string['subscription_state'] = '<strong> Compilatio.net aboneliğinizin süresi {$a->end_date} bitiminde sona erecek. Bu ay, {$a->used} dokümanların en az, 5000 kelimeyi içeren eşdeğerini analiz ettiniz. </ strong>';
...
$string['trigger_timed_analyses'] = 'Tetiklenen planlı intihal analizi';

...
/**
 * Strings for component 'plagiarism_urkund', language 'tr', version '3.10'.
 *
...
$string['urkund_lang_help'] = 'URKUND tarafından sağlanan dil kodu';
$string['urkund_password'] = 'Parola';
$string['urkund_password_help'] = 'API\'ye erişmek için URKUND tarafından sağlanan şifre';
$string['urkund_receiver'] = 'Alıcı adresi';
$string['urkund_receiver_help'] = 'URKUND tarafından öğretmen için verilen benzersiz adres budur';
...
$string['urkund_username_help'] = 'API\'ya erişmek için URKUND tarafından sağlanan kullanıcı adı';

...
/**
 * Strings for component 'subcourse', language 'tr', version '3.10'.
 *
 * @package     subcourse
 * @category    string
...
$string['modulenameplural'] = 'Altdersler';
...
$string['refcourse_help'] = 'Başvurulan ders, faaliyet notunun alındığı derstir. Öğrenciler, atıfta bulunulan kursa kaydolmalıdırlar.

Burada listelenmesini sağlamak için kursta bir öğretmen olmalısınız. Site yöneticinizden, bu dersi başka derslerden almanız için kurmasını isteyebilirsiniz.';

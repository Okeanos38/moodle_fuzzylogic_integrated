...
/**
 * Strings for component 'qtype_regexp', language 'tr', version '3.10'.
 *
...
$string['regexperroroddunderscores'] = '<strong>HATA!</ strong> Çift köşeli parantezlerinizde ODD sayıda alt çizgi var!';
...
$string['regexperrortoomanypermutations'] = '<strong>HATA!</ strong> Her cevap için izin verilen en fazla 2 permütasyon grubu (çift köşeli ayraç)!';

...
/**
 * Strings for component 'folder', language 'tr', version '3.10'.
 *
 * @package     folder
 * @category    string
...
$string['display_help'] = 'Klasör içeriğini bir ders sayfasında göstermeyi seçerseniz, ayrı bir sayfaya bağlantı olmayacaktır.
Açıklama, yalnızca "Ders sayfasında açıklama göster" seçeneği işaretlendiğinde görüntülenir. <br />
Ayrıca, katılımcıların bu davada eylemlerin kaydedilemediğini görüyoruz.';
...
* Ders sayfasındaki öğretmenler için paylaşılan bir yükleme alanı sağlamak (yalnızca öğretmenlerin görebilmesi için klasörü gizli tutmak için)';
...
$string['showdownloadfolder'] = 'İndirme klasörü göster düğmesi';

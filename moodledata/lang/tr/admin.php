...
/**
 * Strings for component 'admin', language 'tr', version '3.10'.
 *
 * @package     admin
 * @category    string
...
$string['allowblockstodock'] = 'Kullanıcıların sayfa kenarını kullanmasına izin ver';
$string['allowcategorythemes'] = 'Kategori temalarına izin ver';
$string['allowcohortthemes'] = 'Grup temalarına izin ver';
$string['allowcoursethemes'] = 'Ders temalarına izin ver';
...
$string['availablelicenses'] = 'Mevcut lisanslar';
$string['availableto'] = 'Uygun';
$string['backgroundcolour'] = 'Transparan renk';
$string['backup_shortname'] = 'Yedekleme dosya adında ders adını kullan';
$string['backup_shortnamehelp'] = 'Ders adı yedekleme dosya adınıniçinde geçsin.';
...
$string['blockprotect_help'] = 'Eğer belirli tipteki bir bloğu kilitlerseniz, kimse bu tipteki blok kullanımlarını ekleyemez veya silemez. (Eğer kullanımları düzenlemek gerekiyorsa, tabii ki, tekrar kilidini açabilirsiniz.)
...
$string['cfgwwwrootwarning'] = 'config.php dosyasındaki $CFG->wwwroot hatalı tanımlandı. Bu sayfaya erişmek için kullandığınız URL ile eşleşmiyor. Lütfen bunu düzeltin. Yoksa bu hatayı alırsınız: <a href=\'http://tracker.moodle.org/browse/MDL-11061\'>MDL-11061</a>.';
...
$string['clistatusenabled'] = 'Durum : Aktif';
...
$string['cliupgradefinished'] = 'Komut satırı güncellemesi başarılı';
...
$string['commonactivitysettings'] = 'Genel ayarlar';
...
$string['configallowassign'] = 'Soldaki rollere sahip insanlara bazı sütun rollerini diğer insanlara atamaları için izin verebilirsiniz';
$string['configallowattachments'] = 'Etkinleştirilirse, siteden gönderilen e-postalarda rozet gibi ekler olabilir.';
$string['configallowblockstodock'] = 'Etkinse ve seçili tema tarafından destekleniyorsa, kullanıcılar blokları özel bir sayfa kenarı bölümüne taşıyabilir.';
...
$string['configallowcoursethemes'] = 'Etkinleştirseniz, ders teması ayarlanmasına izin verilir. Ders temaları diğer tüm tema seçeneklerini (site, kullanıcı veya oturum temaları) geçersiz kılar.';
...
$string['configallowemailaddresses'] = 'Bütün e-posta adreslerini belirli alan adlarıyla sınırlamak istiyorsanız aralarında boşluk bırakarak buraya girin. Diğer bütün alan adları reddedilir. Alt alan adlarına izin vermek için  alan adlarını \'.\' ile ekleyin. Ör: <strong>universitem.edu.tr .mil.tr</strong>';
...
$string['configallowguestmymoodle'] = 'Etkinse, misafirler kontrol paneline erişebilirler. Etkin değil ise, site ön sayfasına yönlendirilirler.';
$string['configallowobjectembed'] = 'Öntanımlı bir güvenlik ölçütü olarak, normal kullanıcıların, html içerisinde EMBED ve OBJECT etiketleri kullanarak metinlerin içerisine multimedia dosyaları gömmesine (mediapluginleri yardımıyla güvenli şekilde yapılabilmesine karşın) izin verilmez.  Eğer bu etiketlere izin vermek isterseniz bu seçeneği aktive edin.';
...
$string['configallowoverride2'] = 'Sol sütundaki her bir rol tarafından hangi rolün/rollerin yeniden tanımlanabileceğini seçin.<br/>Bu ayarların yalnızca moodle/role:override veya moodle/role:safeoverride yetkisi olan kullanıcılara uygun olduğunu unutmayın.';
$string['configallowswitch'] = 'Kullanıcının geçiş yapabileceği rolleri sahip olduğu rolü temel alarak seçin. Kullanıcının geçiş yapabilmesi için bu tablodaki girişin yan ısıra, moodle/role:switchroles yeteneğine de sahip olması gerekir.<br /> Dikkate almanız gereken, yalnızca moodle/course:view yeteneğine sahip olup moodle/site:doanything yeteneğine sahip olmayan rollere geçiş yapmanın mümkün olduğudur; bu yüzden bu tablodaki bazı sütunlar geçersiz kılınmıştır.';
$string['configallowthemechangeonurl'] = 'Bu ayar etkinleştirilirse, herhangi bir Moodle adresine  iunlar eklenerek tema değiştirilebilir: < br / >?theme=temanın adı (örneğin: moodlesitesi.com/?theme=afterburner) ya da <br />&theme=temanın adı (örneğin: moodlesitesi.com/course/view.php?id=2&theme=afterburner).';
...
$string['configallowuserthemes'] = 'Eğer bunu aktive ederseniz, kullanıcıların kendi temalarını kurmasına izin verirsiniz. Kullanıcı temaları site temalarını devre dışı bırakır. (ders temalarını bırakmaz)';
$string['configallowview'] = 'Bir kullanıcının hangi rolleri göreceğini, zaten hangi rollere göre filtreleyebileceğini vb. Seçin.';
$string['configallusersaresitestudents'] = 'TÜM kullanıcılar, sitenin giriş sayfasındaki bütün etkinlikler için öğrenci olarak kabul edilecek mi? Yanıt \'Evet\' ise, hesabı onaylanmış herhangi bir kullanıcının bu etkinliklere öğrenci olarak katılmasına izin verilecektir. Şayet \'Hayır\' ise, en az bir derse kayıtlı olan kullanıcılar giriş sayfası etkinliklerine katılabilecektir. Sadece yöneticiler ve özel olarak atanmış eğitimciler giriş sayfasındaki bu etkinliklerde eğitimci olarak rol alabilirler.';
...
$string['configautolangusercreation'] = 'Kullanıcı oluşturma sırasında kullanıcıların tarayıcısındaki dili kullanın';
...
$string['configcourseoverviewfilesext'] = 'İzin verilen ders özeti dosya uzantılarının virgülle ayrılmış (csv) listesi';
$string['configcourseoverviewfileslimit'] = 'Bir ders özetine eklenebilecek maximum dosya sayısı';
...
$string['configcoursesperpage'] = 'Bir ders listesinde sayfa başına görüntülenecek ders sayısını girin.';
$string['configcourseswithsummarieslimit'] = 'Daha basit bir listelemeye dönmeden önce dersin özetini de içeren ders listesinde gösterilecek maksimum sayı.';
...
$string['configcustommenuitems'] = 'Menünüzü örneğe göre oluşturabilirsiniz. Her satır menüye eklenecek bir ad, bağlantı için URL (isteğe bağlı), bir ipucu başlığı (isteğe bağlı) ve dil kodu or virgüller ayrılmış kod listesi (isteğe bağlı, farklı dillerdeki kullanıcılar için) içerir; bunlar dik çizgiyle (|) birbirinden ayrılır. Kısa çizgiyle başlayan satırlar önceki üst düzey menü başlığının menü unsurları olarak görünür ve istenen yerlere bir ya da daha fazla # simgesinden oluşan satırlar eklenerek ayraşlar oluşturulabilir. Örnek
<pre>
Moodle topluluğu|https://moodle.org
-Moodle ücretsiz destek|https://moodle.org/support
-Moodle belgeleri|http://docs.moodle.org|Moodle Docs
-Almanca Moodle belgeleri|http://docs.moodle.org/de|Documentation in German|de
Moodle.com|http://moodle.com/
-###
-Moodle geliştirme|https://moodle.org/development
Moodle.com|http://moodle.com/
</pre>';
$string['configcustomusermenuitems'] = 'Kullanıcı menüsünün (kendiliğinden eklenen çıkış bağlantısı dışında) içeriğini yapılandırabilirsiniz. Her satır | ile ayrılır ve şunlardan oluşur: 1) "langstringname, componentname" formunda bir dizge veya düz metin, 2) bir URL ve 3) bir pix icon ya da URL biçiminde yalın bir metin. İstenen yere satır halinde # eklenerek ayraçlar oluşturulabilir.';
...
$string['configdefaulthomepage'] = 'Giriş yapmış kullanıcılar için ana sayfayı belirler';
$string['configdefaultrequestcategory'] = 'Kullanıcılar tarafından talep edilen dersler otomatik olarak bu kategoride yer alacaktır.';
$string['configdefaultrequestedcategory'] = 'Talep edilen ders onaylanırsa hangi kategoride yer alacak?';
...
$string['configdeleteunconfirmed'] = 'E-posta yoluyla giriş yapma yöntemini kullanıyorsanız, kullanıcının ne kadar sürede onayla göndermesi gerektiğini belirtir. Bu süreden sonra, onaylanmamış eski hesaplar silinecektir.';
...
$string['configdndallowtextandlinks'] = 'Ders sayfasında metin ve linkler için sürükle bırakı etkinleştirin veya kapatın. Firefox içinde veya farklı tarayıcılar arasında metin sürüklemenin güvenilmez olduğunu unutmayın; hiçbir veri yüklenmemesi ya da bozuk metin yüklemesi ile sonuçlanabilir.';
$string['configdoclang'] = 'Belgeler sayfalarındaki bağlantılar için bu dil kullanılır.';
$string['configdocroot'] = 'Her bir sayfanın altındaki \'Bu sayfa için Moodle belgeleri\' başlantısı yoluyla içeriğe özgü Moodle Belgelerinin yolunu tanımlar. Boş bırakılırsa başlantılar gösterilmez.';
...
$string['configemailfromvia'] = 'Giden e-postanın "Kimden" bölümüne bilgi ekleyin.Bu, alıcıyı bu e-postanın geldiği yer konusunda bilgilendirir ve yanlışlıkla yanıtsız e-posta adreslerine yanıt yazan alıcılarla mücadele etmeye yardımcı olur.';
...
$string['configenableactivitychooser'] = 'Etkinlik seçici, her etkinliğin ve kaynağın kısa bir tanımını içeren bir iletişim kutusudur. Devre dışı bırakılırsa, ayrı kaynak ve etkinlik açılır menüleri sunulur.';
...
$string['configenablecomments'] = 'Yorumları aç';
$string['configenablecourserequests'] = 'Bu herhangi bir kullanıcının ders oluşturma talebinde bulunmasına izin verir.';
...
$string['configenablerssfeedsdisabled'] = 'RSS içeriği tüm sitede etkinlik dışı bırakıldığı için buna erişilemez. Etkinleştirmek için Yönetim/Yapılandırma ayarlarından Değişkenler bölümüne gidin.';
...
$string['configenablestats'] = 'Burada \'Evet\'i seçerseniz cronjob, kütükleri ve gerekli bazı istatistikleri işleme alır. Sitenizin trafiğine bağlı olarak bu biraz zaman alabilir. Bunu etkinleştirirseniz her bir dersiniz hakkında ya da site bazında bazı ilginç grafikler ve istatistikler görebilirsiniz.';
...
$string['configextendedusernamechars'] = 'Öğrencilerin kullanıcı adlarında isteği herhangi bir karakteri seçebilmesini istiyorsanız bu ayarı etkinleştirin (adı ve soyadını etkilemez). Varsayılan değer \'hayır\' ile sadece İngilizceki alfanümerik küçük harfler, alt çizgi (_), tire (-), nokta (.) veya @ simgesi kullanılabilir.';
...
$string['configfiltermatchonepertext'] = 'Otomatik linkleme filtresi, bir metinde (kaynaklar, bloklar gibi) eşleşen sadece ilk link için bağlantı oluşturacaktır. Diğer hepsi yok sayılır. Her sayfada için ayarı <i>evet</i> ise bu ayar yok sayılır.';
...
$string['configfrontpagecourselimit'] = 'Maximum ders sayısı';
$string['configfrontpagecourselimithelp'] = 'Ders listelerinde sitenin ön sayfasında görüntülenecek en fazla ders sayısı.';
...
Çoğu tek-dilli siteler için "Adı Soyadı" en uygun olan ayardır, ancak soyadları tamamen gizlemeyi seçebilirsiniz. Şu alanlar  yer tutucular kullanılabilir: ad, soyad, firstnamephonetic, lastnamephonetic, middlename ve alternatename.';
$string['configgeoipfile'] = 'GeolP City ikili veri dosyasının yeri. Bu dosya Moodle dağılımının parçası değildir ve ayrı olarak <a href="http://www.maxmind.com/">MaxMind</a> adresinden alınmalıdır. Ticari sürümünü alabileceğiniz gibi, ücretsiz sürümünü de kullanabilirsiniz.<br /><a href="http://www.maxmind.com/download/geoip/database/GeoLiteCity.dat.gz" >http://www.maxmind.com/download/geoip/database/GeoLiteCity.dat.gz</a> dosyasını indirerek sunucunuzdaki "{$a}" dizinine çıkartmanız yeterli olacaktır.';
...
$string['confighiddenuserfields'] = 'Diğer kullanıcılardan, ders yöneticileri ve eğitimcileri hariç, hangi kullanıcı bilgilerinin gizli kalmasını istediğinizi belirleyin. Bu ayar öğrenci gizliliğini arttırır. Birden fazla alan seçmek için CTRL tuşuna basılı tutun.';
...
$string['configmaxbytes'] = 'Bu siteye yüklenen dosyaların en fazla ne kadar boyutta olacağını belirtir. Bu ayar, PHP tarafından post_max_size ve upload_max_filesize ile, Apache tarafından LimitRequestBody ile sınırlandırılmıştır. Maxbytes sınırı ayrıca ders ve eklenti seviyesinde de ayarlanabilir. \'Sunucu Limit\' seçilirse, sunucu tarafından izin verilen en fazla boyut kullanılır.';
...
$string['configmessagingallusers'] = 'Etkinleştirilirse, kullanıcılar ileti gönderecek birini seçerken sitedeki tüm kullanıcıların listesini görüntüleyebilir ve ileti tercihleri, sitedeki herhangi bir kişiden gelen iletileri kabul etme seçeneğini içerir. Devre dışı bırakılırsa, kullanıcılar yalnızca kurslarındaki kullanıcıların listesini görüntüleyebilir ve mesaj tercihlerinde yalnızca iki seçeneğe sahiptir - yalnızca kişilerinden veya kişilerinden ve kurslarındaki herkesden gelen iletileri kabul etmek için.';
...
$string['configmodchooserdefault'] = 'Etkinlik seçici varsayılan olarak kullanıcılara sunulacak mı?';
...
$string['confignavcourselimit'] = 'Kullanıcıya dolaşımda gösterilecek ders sayısını sınırlandırır.';
$string['confignavshowallcourses'] = 'Bu ayar kullanıcıların navigasyon alanında Benim Derslerim (kaydolunan dersleri listeler) linkine ek olarak Dersler (tüm dersleri listeler) linkini görüp görmeyeceğini belirler.';
$string['confignavshowcategories'] = 'Gezinme bloklarında ve gezinme çubuğunda ders kategorilerini göster. Bu; öğrencinin zaten kayıtlı  olduğu derslerde gerçekleşmez - bu dersler kategoriler olmaksızın mycourses bağlantısı altında gösterilir.';
...
$string['configprofileroles'] = 'Katılım sayfası ve kullanıcı profil sayfasındaki görünür rollerin listesi.';
...
$string['configrecaptchaprivatekey'] = 'Moodle sunucunuz ile recaptcha.net sunucusu arasındaki iletişimde kullanılan karakterler dizgisi (prıvate key). ReCAPTCHA anahtarları <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a> adresinden alınabilir.';
$string['configrecaptchapublickey'] = 'Kayıt formunda reCAPTCHA öğesini görüntülemek için kullanılan karakterler dizgisi (publıc kez). ReCAPTCHA anahtarları <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a> adresinden alınabilir.';
$string['configrequestcategoryselection'] = 'Ders talep ederken kategori seçilmesine izin ver.';
...
$string['configuseblogassociations'] = 'Kendi bloglarını kullanıcılar girdileri derslerle ve ders modülleriyle ilişkilendirerek düzenleyebilsinler mi?';
$string['configuseexternalyui'] = 'Yerel dosyaları kullanmak yerine, Yahoo sunucularında mevcut çevrimiçi dosyaları kullan. UYARI: Bu bir internet bağlantısı gerektirir, ya da sitenizde hiç AJAX çalışmaz. Bu ayar https kullanan sitelerle uyumlu değildir.';
$string['configuserquota'] = 'Kullanıcıların gizli dosya alanlarında saklayabilecekleri dosyaların toplam maximum boyutu.  {$a->bytes} bytes == {$a->displaysize}';
$string['configusesitenameforsitepages'] = 'Etkinleştirilirse sitenin kısa adı \'Site sayfaları\' metni yerine menüdeki site sayfaları düğümünde kullanılacak.';
...
$string['confirmdeletecomments'] = 'Yorumları silmek üzeresiniz, bunu yapmak istediğinize emin misin?';
...
$string['contextlocking'] = 'Donmuş içerik';
...
$string['coursecontact'] = 'Ders yöneticileri';
$string['coursecontact_desc'] = 'Bu ayar, ders tanıtımında görünen kişiyi kontrol etmenize izin verir. Kullanıcılar bu ders için ders tanıtımında gösterilen rollerden en azından birine sahip olmalıdır.';
...
$string['coursegraceperiodafter'] = 'Geçmiş dersler için ek süre';
$string['coursegraceperiodbefore'] = 'Gelecek dersler için ek süre';
$string['courselistshortnames'] = 'Ders adlarının uzun halini göster';
$string['courselistshortnames_desc'] = 'Etkinleştirilirse, ders listelerindeki tam adlara ek olarak ders kısa adları görüntülenir. Gerekirse, genişletilmiş ders adları, dil özelleştirme özelliğini kullanarak \'courseextendednamedisplay\' dil dizilimini düzenleyerek özelleştirilebilir.';
$string['coursemgmt'] = 'Dersleri ve kategorileri yönet';
...
$string['courserequests'] = 'Ders istekleri';
$string['courserequestspending'] = 'Bekleyen ders istekleri';
$string['courses'] = 'Dersler';
$string['coursesperpage'] = 'Sayfa başına ders';
$string['courseswithsummarieslimit'] = 'Özeti olan dersler için sınır';
...
$string['cron_enabled_desc'] = 'Devre dışı bırakılırsa, sistemin yeni arka plan görevlerini başlatmasını engeller. Bu seçenek yalnızca geçici kullanım içindir, örn. yeniden başlatmadan önce. Uzun süre kapalı bırakmak önemli işlevlerin çalışmasını engelleyecektir.';
...
$string['cronwarning'] = '<a href="cron.php">cron.php bakım betiği</a> en az son 24 saattir çalıştırılmadı.';
$string['cronwarningcli'] = 'cli/cron.php bakım programı son 24 saattir çalışmıyor.';
...
$string['debugsqltrace_desc'] = 'Etkinleştirilirse, açıklama olarak SQL\'de kısmi veya tam PHP yığın izlemesi';
$string['debugstringids'] = 'Dil ifadelerinin yerini göster';
$string['debugstringids_desc'] = 'Bu seçenek, çevirmenlere yardımcı olmak için tasarlanmıştır. Bu seçenek etkinleştirildiğinde, bir istek URL\'sine parametre dizeleri = 1 eklerseniz, çıktılanan her dizenin yanında dil dosyası ve dize kimliği gösterilir.';
...
$string['defaultformatnotset'] = 'Varsayılan ders biçimi belirlenirken hata oluştu. Lütfen site ayarlarını kontrol edin.';
$string['defaulthomepage'] = 'Kullanıcılar için öntanımlı ana sayfa';
...
$string['devlibdirpresent'] = 'Herkese açık sitelerde <em>vendor</em> ya <em>node_modules</em> gibi geliştirme kitaplıkları içeren dizinlerin mevcut olmaması gerekir. Daha fazla ayrıntı için bakınız <a href="{$a->moreinfourl}">genel güvenlik raporu</a>.';
...
$string['divertallemailsexcept_desc'] = 'Virgülle veya yeni satırlarla ayrılmış e-posta istisna kuralları listesi. Her kural normal bir ifade olarak yorumlanır, örneğin <pre> simone@acme.com
. * @ acme.com
fred (\\ +. *)? @ acme.com
</pre>';
...
$string['enableactivitychooser'] = 'Etkinlik seçicisini etkinleştir';
$string['enableanalytics'] = 'Analiz';
$string['enableblogs'] = 'Blogları etkinleştir';
$string['enablecalendarexport'] = 'Takvim dışa aktarımını aktive et';
$string['enablecomments'] = 'Yorumları aç';
$string['enablecourserelativedates'] = 'Ders göreli tarihlerini etkinleştir';
...
$string['enabledevicedetection'] = 'Cihaz tanımayı aktive et';
$string['enableglobalsearch'] = 'Global aramayı etkinleştir';
$string['enableglobalsearch_desc'] = 'Etkinleştirildiğinde, veriler endekslenecek ve bir zamanlanmış görev ile senkronize edilecektir.';
$string['enablegravatar'] = 'Gravatar aktive et';
...
$string['enablerssfeeds'] = 'RSS beslemeleri aktive et';
...
$string['enableuserfeedback'] = 'Moodle hakkında geri bildirimi etkinleştir';
$string['enableuserfeedback_desc'] = 'Etkinleştirilirse, Gösterge Tablosu uyarısında ve altbilgide kullanıcıların Moodle LMS\'den Moodle Genel Merkezine geri bildirimde bulunmaları için bir \'Geri bildirim ver\' bağlantısı görüntülenir. Gösterge Tablosu uyarısında \'Daha sonra hatırlat\' seçeneği de var.';
...
$string['enrolinstancedefaults_desc'] = 'Yeni dersler için varsayılan kayıt olma ayarları';
...
$string['environmentmariadbwrongdbtype'] = 'Yanlış <code>$CFG->dbtype</code>: <code>config.php</code> dosyanızdaki, from \'<code>mysql</code>\' değerini \'<code>mariadb</code>\' olarak değiştirmeniz gerekiyor.';
...
$string['eventshandlersinuse'] = 'Sisteminizdeki aşağıdaki eklentiler, Etkinlikler 1 API kullanımdan kaldırılmış işleyicileri kullanıyor: \'{$a}\'. Lütfen bunları, Etkinlik 2 API\'sini kullanacak şekilde güncelleyin. Https://docs.moodle.org/dev/Event_2#Event_dispatching_and_observers sayfasına göz atın.';
...
$string['fileconversioncleanuptask'] = 'Dosya dönüşümleri için geçici kayıtların silinmesi';
...
$string['formatuninstallwithcourses'] = '{$a->format} biçimini kullanan {$a->count} ders var. Biçimleri {$a->defaultformat} olacak (bu site için varsayılan biçim). Bazı biçime özel veriler kaybolabilir. Devam etmek istediğinizden emin misiniz?';
$string['frontpage'] = 'Ön sayfa';
$string['frontpagebackup'] = 'Ön sayfa yedeklemesi';
...
$string['frontpageoverrides'] = 'Anasayfa izinlerinin üzerine yaz';
$string['frontpagequestions'] = 'Ön sayfa soruları';
$string['frontpagerestore'] = 'Ön sayfa geri yüklemesi';
$string['frontpageroles'] = 'Ön sayfa rolleri';
...
$string['groupenrolmentkeypolicy_desc'] = 'Bunu açtığınızda, Moodle, grup kayıt anahtarlarını geçerli bir şifre politikasına karşı kontrol edecektir.';
...
$string['helpshowicalsource'] = 'Etkinse, iCal\'dan içe alınan etkinliklerde abone ismi ve bağlantısı görüntülenir.';
...
$string['invalidthemepreset'] = 'Seçilen hazır ayar dosyası bu tema ile uyumlu değil. SCSS derleme hatası şuydu: "{$a}"';
...
$string['ipblockersyntax'] = 'Her girişi tek bir satıra koyun. Geçerli girişler, tek bir ana bilgisayarla eşleşen tam IP adresidir (<b> 192.168.10.1 </ b> gibi); Veya bu numaralardan başlayarak herhangi bir adresle eşleşen kısmi adres (<b> 192.168 </ b> gibi); Veya CIDR gösterimi (<b> 231.54.211.0/20 </ b> gibi); Veya aralığın adresin son kısmı için geçerli olduğu bir dizi IP adresi (<b> 231.3.56.10-20 </ b> gibi). Metin alan adları (\'example.com\' gibi) desteklenmez. Boş satırlar yok sayılır.';
$string['iplookup'] = 'IP adresi araması';
$string['iplookupgeoplugin'] = '<a href="http://www.geoplugin.com">geoPlugin</a> servisi coğrafik bilgi edinmek için kullanılıyor. Daha isabetli sonuçlar için, MaxMind GeoLite veritabanının yerel bir kopyasını yüklemenizi tavsiye ederiz.';
$string['iplookupinfo'] = 'Varsayılan olarak Moodle IP adreslerinin yerlerini bulmak için ücretsiz çevrimiçi NetGeo (Internet Coğrafi Veritabanı) sunucusundan yararlanır, ne yazık ki bu veritabanı artık güncellenmediğinden <em>tamamen yanlış veriler</em> verebilir.
MaxMind\'den ücretsiz GeoLite City veritabanının yerel bir kopyasının yüklenmesi önerilir.<br />
IP adres yeri Google Haritalarından yararlanarak ya da basit harita üzerinde görüntülenir. Lütfen etkileşimli haritaları etkin kılmak için bir Google hesabına ek olarak, ücretsiz Google Haritaları API anahtarına başvurmanız gerektiğini unutmayın.';
...
$string['legacyfilesaddallowed'] = 'Eski ders dosyalarına eklemeye izin ver';
$string['legacyfilesaddallowed_help'] = 'Bir ders, eski ders dosyalarına sahipse, yeni dosya ve klasörlerin eklenmesine izin verin.';
$string['legacyfilesinnewcourses'] = 'Yeni kurslarda eski ders dosyaları';
$string['legacyfilesinnewcourses_help'] = 'Varsayılan olarak, eski ders dosyaları alanları yalnızca yeni sürüme geçirilmiş kurslarda kullanılabilir. Etkinlik yedekleme ve geri yükleme gibi bazı özelliklerin bu ayarla uyumlu olmadığını lütfen unutmayın.';
...
$string['linkcoursesections'] = 'Her zaman ders bölümlerini bağlayın';
$string['linkcoursesections_help'] = 'Her zaman ders bölümleri için bir bağlantı sağlamaya çalışın. Ders bölümleri genelde yalnızca ders formatında sayfa başına tek bir bölüm gösteriyorsa bağlantılar olarak gösterilir. Bu ayar etkinleştirilirse, bir bağlantı daima sağlanır.';
...
$string['lockoutthreshold_desc'] = 'Hesabın kilitlenmesi için gerekli başarısız oturum açma girişim sayısını  seçin. Bu özellik DoS saldırıları istismarına neden olabilir.';
...
$string['logo'] = 'Logo';
$string['logo_desc'] = 'Bazı temalar (örneğin temel temalar) tarafından dekorasyon olarak kullanılmak üzere tam bir logo. Bu görüntü oldukça yüksek çözünürlüklü olabilir çünkü kullanım için küçültülür (ve performans için ön belleğe alınır). Yüksekten daha geniş logolar genellikle daha iyi sonuçlar verir. Kabul edilen biçimler: PNG ve JPG.';
$string['logocompact'] = 'Küçük logo';
$string['logocompact_desc'] = 'Amblemi, ekranı veya simgesi gibi, yukarıdaki ile aynı logoyu içeren küçük bir versiyonu. Görüntü küçük boyutlarda bile net olmalıdır. Kabul edilen biçimler: PNG ve JPG.';
...
$string['mobilenotconfiguredwarning'] = 'Moodle Mobile Etkinleştirilmedi.';
$string['modchooserdefault'] = 'Varsayılan etkinlik seçici';
...
$string['navadduserpostslinks_help'] = 'Etkinleştirilirse, kullanıcıların başlattığı tartışmaları görüntülemek için gezinme alanındaki her kullanıcıya iki bağlantı eklenecek ve kullanıcının sitelerdeki forumlarda veya belirli derslerde yaptığı mesajlar etkinleştirilecek.';
$string['navcourselimit'] = 'Ders sınırı';
...
$string['navshowallcourses'] = 'Tüm dersleri göster';
$string['navshowcategories'] = 'Ders kategorilerini göster';
$string['navshowfrontpagemods'] = 'Gezinme bloğunda ön sayfa etkinliklerini göster';
$string['navshowfrontpagemods_help'] = 'Etkinse, ön sayfa etkinlikleri, site sayfalarının altındaki Gezinme bloğunda görüntülenir.';
$string['navshowfullcoursenames'] = 'Dersin tam adını göster';
$string['navshowfullcoursenames_help'] = 'Etkinleştirilirse, kısa adlar yerine ders tam adları navigasyonda kullanılacaktır.';
$string['navshowmycoursecategories'] = 'Ders kategorilerimi göster';
$string['navshowmycoursecategories_help'] = 'Kullanıcılardaki kursları etkinleştirirseniz, kurslarımdaki dallar kategoriler halinde gösterilir.';
$string['navsortmycourseshiddenlast'] = 'Gizli derslerimi en son sırala';
$string['navsortmycourseshiddenlast_help'] = 'Etkinleştirilirse, gizli dersler görünür derslerden sonra listelenir (gizli dersleri görüntüleyebilen kullanıcılar için). Aksi takdirde, görünürlüklerine bakılmaksızın tüm dersler \'Derslerimı sırala\' ayarına göre listelenir.';
$string['navsortmycoursessort'] = 'Derslerimi sırala';
$string['navsortmycoursessort_help'] = 'Bu, derslerin sıralama düzene göre (yani, Site yönetimi> Dersler> Dersleri ve kategorileri yönet ayarında) veya ders ayarına göre alfabetik olarak Derslerimin altında listeleneceğini belirler.';
$string['never'] = 'Asla';
...
$string['pathtodot_help'] = 'dot dizinin adresi muhtemelen /usr/bin/dot şeklindedir. DOT dosyalarından grafik üretebilmek için dot çalıştırılabilir dosyalarını yüklemeli ve bu adresi göstermelisiniz. Şimdilik sadece moodle içerindeki yerleşik profil işleme özellikleri (Development->Profiling) ile kullanıldığına olduğuna dikkat ediniz.';
...
$string['pathtopythondesc'] = 'Çalıştırılabilir Python ikili dosya yolu.';
...
$string['profilefieldlink_help'] = 'Metni bir bağlantıya dönüştürmek için, $$ harfi içeren bir URL girin, burada $$ harfi değiştirilecektir. Örneğin, bir Twitter kimliğini bir bağlantıya dönüştürmek için http://twitter.com/$$ yazın.';
...
$string['profilevisible_help'] = '*Görünmez - Özel verileri sadece yöneticiler tarafından görüntülenebilir
*Kullanıcı izinli - Özel verileri sadece yöneticiler ve kullanıcıları görüntüleyebilir
...
$string['registermoodlenet'] = '<p> Moodle siteniz için önemli şeyler için iletişime geçmek isteriz! </p> <p> Kaydolarak, </p> <ul> <li> Kullanıcılarla ilgili toplu bilgilerimize katkıda bulunuyorsunuz. </li> <li> Güvenlik uyarıları ve yeni Moodle bültenleri gibi önemli bildirimleri öğrenen ilklerden biri olacaksınız. </li> <li> Mobil push bildirimlerini, ücretsiz <a href="https://download.moodle.org/mobile/"> Moodle Mobile uygulaması </a> aracılığıyla Moodle sitenize erişebilir ve etkinleştirebilirsiniz. </li> <li> İsteğe bağlı olarak , siteniz <a href="https://moodle.net/stats"> kayıtlı siteler listesinde </a> Moodle topluluğunun gururlu üyesi ve destekçisi olarak dahil edilebilir. </li> </ul >';
$string['registermoodleorg'] = 'Sitenizi kaydettiğiniz zaman';
$string['registermoodleorgli1'] = 'Güvenlik uyarıları ve Moodle\'ın yeni sürümleri gibi önemli bildirimler için, düşük hacimli e-posta listesine eklendiniz.';
$string['registermoodleorgli2'] = 'Siteniz ile ilgili istatistikler dünya çapındaki {$a} Moodle topluluğuna eklenecektir.';
...
$string['requestcategoryselection'] = 'Kategori seçimini etkinleştir';
...
$string['search'] = 'Ara';
$string['searchablecourses'] = 'Aranabilir dersler';
$string['searchallavailablecourses'] = 'Aranabilir dersler';
...
$string['searchallavailablecourses_off'] = 'Yalnızca kayıtlı derslerde arama yapın';
$string['searchallavailablecourses_on'] = 'Kullanıcının erişebileceği tüm dersleri ara';
...
$string['showuseridentity_desc'] = 'Kullanıcıları seçerken veya ararken ve kullanıcı listelerini görüntülerken, bu alanlar tam adlarına ek olarak gösterilebilir. Alanlar yalnızca moodle / site: viewuseridentity özelliği olan kullanıcılara gösterilir; Varsayılan olarak, öğretmenler ve yöneticiler. (Bu seçenek, kurumunuzda zorunlu olan bir veya iki alan seçerseniz en mantıklı olur.)';
...
$string['sixtyfourbitswarning'] = 'Sitenizin 64 bit PHP sürümü kullanmadığı tespit edildi. İleride uyumluluk sağlamak için sitenizi yeni sürüme geçirmeniz önerilir.';
...
$string['sort_fullname'] = 'Dersin tam adı';
$string['sort_idnumber'] = 'Dersin ID numarası';
$string['sort_shortname'] = 'Dersin kısa adı';
...
$string['task_logretention_desc'] = 'Günlüklerin saklanması gereken maksimum süre. Bu ayar \'Çalışmaları koru\' ayarıyla etkileşime girer: hangisine önce ulaşılırsa uygulanır';
...
$string['taskanalyticscleanup'] = 'Analizleri temizle';
$string['taskautomatedbackup'] = 'Otomatik yedekleme';
$string['taskbackupcleanup'] = 'Yedekleme dosyaları ve kayıtları temizle';
$string['taskbadgescron'] = 'Ödül rozetleri';
...
$string['taskquestioncron'] = 'Soru motoru arka planda işleniyor';
$string['taskquestionstatscleanupcron'] = 'Soru istatistikleri önbelleklerini temizlemek için arka plan işleme';
...
$string['testoutgoingmailconf_message'] = 'Bu, sitenizin giden postasını başarıyla yapılandırdığınızı doğrulayan bir test mesajıdır.';
...
$string['testoutgoingmailconf_subject'] = '{$a}: test mesajı';
...
$string['unsupporteddbfileformat'] = 'Veritabanınızda dosya formatı olarak Antelope kullanan tablolar var. MySQL ve MariaDB içinde eksiksiz UTF-8 desteği için Barracuda dosya formatı gerekir. Lütfen tabloları Barracuda dosya formatına dönüştürün. InnoDB tablolarını Barracuda formatına dönüştürme gereci hakkında ayrıntılar için <a href="https://docs.moodle.org/en/cli">Administration via command line</a> belgelendirmesine bakın.';
...
$string['unsupportedphpversion7'] = 'PHP versiyon 7 desteklenmiyor.';
$string['unsupportedphpversion71'] = 'PHP sürüm 7.1 desteklenmiyor.';
$string['unsupportedphpversion72'] = 'PHP sürüm 7.2 desteklenmiyor.';
$string['unsupportedphpversion73'] = 'PHP sürüm 7.3 desteklenmiyor.';
$string['unsupportedphpversion74'] = 'PHP sürüm 7.4 desteklenmiyor.';
...
$string['userfeedbackencouragement'] = '<p>Moodle 3.9, Moodle Genel Merkezi tarafından barındırılan harici bir anket sitesi aracılığıyla kullanıcılara Moodle yazılımı hakkında Moodle yazılımı hakkında geri bildirim sağlama seçeneği sunan yeni bir özellik içerir. Anket sitesine hiçbir kullanıcı tanımlayıcı bilgi yönlendirilmez.</p>
<p>Moodle Genel Merkezi, veri toplama uygulamaları konusunda açık ve şeffaf olmaya çalışmaktadır. Bu nedenle, bu işlevselliğin farkında olduğunuzdan ve kontrolünüzde olduğundan emin olmak istiyoruz.</p>
<p>Kullanıcılardan gelen geri bildirimler, Moodle yazılımının geliştirilmesinde Moodle HQ\'ya büyük ölçüde yardımcı olacaktır. Bu özelliği etkinleştirmek için lütfen <a href="{$a}">Geri bildirim ayarları</a>\'na gidin.</p>';
...
$string['xmlrpcrecommended'] = 'XMLRPC uzantısı, web servisleri ve Moodle ağı içinde kullanışlıdır.';

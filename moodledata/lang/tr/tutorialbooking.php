...
/**
 * Strings for component 'tutorialbooking', language 'tr', version '3.10'.
 *
...
$string['attendees'] = 'Şu anda kaydoldu';
...
$string['editsession'] = 'Düzenle/Taşı/Kopyala';
$string['editsessionheading'] = 'Varolan Zaman Aralığını Düzenle';
...
$string['exportcsvlistallprompt'] = 'Bu dersdeki tüm öğretici kayıtları CSV olarak dışa aktar';
$string['exportlistprompt'] = 'Bu kullanıcı kayıt listesini dışa aktar';
$string['first'] = 'İlk';
...
$string['newsessionhelp'] = 'Yukarıdaki kayıt listesinde yeni bir zaman aralığı oluşturmak için, lütfen aşağıdaki formu doldurun.';
...
$string['save'] = 'Kaydet';
$string['saveasnew'] = 'Yeni zaman aralığını kaydet';
...
$string['studentcoltitle'] = 'Öğrenci adı';

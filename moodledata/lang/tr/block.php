...
/**
 * Strings for component 'block', language 'tr', version '3.10'.
 *
 * @package     block
 * @category    string
...
$string['addtodock'] = 'Bunu dock\'a taşı';
...
$string['blocksdrawertoggle'] = 'Blok işlemcisini gizle/göster';
...
$string['deleteblockcheck'] = '{$a} başlıklı bu bloğu silmek istediğinizden emin misiniz?';
...
$string['dockblock'] = '{$a} bloğunu dock\'a taşı';
$string['hideblock'] = '{$a} bloğunu gizle';
$string['hidedockpanel'] = 'Dock paneli gizle';
...
$string['showonfrontpageandsubs'] = 'İlk sayfa ve ilk sayfaya eklenmiş sayfalarda göster';
$string['showonfrontpageonly'] = 'Sadece  ön sayfada göster';
$string['subpages'] = 'Sayfaları seç';
$string['thisspecificpage'] = 'Bu özel sayfa';
$string['undockall'] = 'Tümünü dock\'tan çıkar';
$string['undockblock'] = '{$a} bloğunu dock\'tan çıkar';
$string['undockitem'] = 'Bu öğeyi dock\'tan çıkar';

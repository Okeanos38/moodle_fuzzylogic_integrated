...
/**
 * Strings for component 'error', language 'tr', version '3.10'.
 *
 * @package     error
 * @category    string
...
$string['cannotgeoplugin'] = 'http://www.geoplugin.com adresindeki geoPlugin sunucusuna bağlanılamıyor, lütfen proxy ayarlarını kontrol edin veya en iyisi MaxMind GeoLite City veri dosyasını yükleyin';
...
$string['cannotmovecourses'] = 'Dersleri, içinde bulunduğu kategoriden başka bir kategoriye taşıyamazsınız.';
...
$string['cannotservefile'] = 'Dosya sağlanamadı - sunucu yapılandırma sorunu';
...
$string['courseformatnotfound'] = '\'{$a}\' ders biçimi yok veya tanınmıyor';
...
$string['detectedbrokenplugin'] = '"{$a}" eklentisi hatalı veya tarihi geçmiş, devam edilemiyor, üzgünüz.';
...
$string['gradesneedregrading'] = 'Ders notlarının yeniden hesaplanması gerekiyor';
$string['groupalready'] = 'Kullanıcı {$a} grubuna zaten kayıtlı';
$string['groupexistforcourse'] = '"{$a}" grubu bu kursta zaten var';
$string['groupexistforcoursewithidnumber'] = '{$a->problemgroup}: Bu ders için "{$a->idnumber}" ID numaralı "{$a->name}" Grubu zaten var';
...
$string['invalidcommentid'] = 'Geçersiz yorum ID\'si';
$string['invalidcommentitemid'] = 'Geçersiz yorum itemid\'si';
...
$string['invalidcourseid'] = 'Geçersiz bir dersin ID nosunu kullanmaya çalışıyorsunuz';
...
$string['invalidshortname'] = 'Bu geçersiz bir ders kısa adı';
...
$string['listcantmovedown'] = 'Öge aşağı taşınamadı, zaten en sonda';
...
$string['listcantmoveup'] = 'Öge yukarı taşınamadı, zaten en üstte';
...
$string['loginasonecourse'] = 'Bu derse giremezsiniz.<br />Başka bir derse girmeden önce "Farklı giriş" oturumunu sonlandırmanız gerekir.';
...
$string['mimetexisnotexist'] = 'Sisteminiz mimeTeX çalıştırmak için yapılandırılmamış. <a href="http://moodle.org/download/mimetex/">http://moodle.org/download/mimetex/</a> adresinden PHP_OS platformu için uygun programı indirmeniz veya <a href="http://www.forkosh.com/mimetex.zip"> http://www.forkosh.com/mimetex.zip</a> adresinden C kaynak kodunu tedairk edip derlemeniz ve çalıştırılabilir kodu moodle/filter/tex/ dizinine koymanız gerekiyor.';
...
$string['nopermissiontoupdatecalendar'] = 'Üzgünüz, ama şu anda takvim etkinliğini güncellemek için izniniz yok';
...
$string['pagenotexist'] = 'Alışılmadık bir hata oluştu (var olmayan bir sayfaya ulaşmaya çalışıldı)';
...
$string['requireloginerror'] = 'Ders veya etkinlik erişilemez.';
...
$string['sessionipnomatch2'] = 'Üzgünüz, ancak IP numaranız ilk oturum açtığınızdan sonra değişmiş gibi görünüyor. Bu güvenlik özelliği, bu sitede oturum açtığınızda cracker\'ların kimliğinizi çalmasını önler. Bu hatayı, kablosuz ağ kullanıyorsanız veya farklı ağlar arasında dolaşıyorsanız görebilirsiniz. Daha fazla yardım için site yöneticisi ile görüşün.<br /><br />Devam etmek istiyorsanız bu sayfayı yenilemek için F5 tuşuna basın lütfen.';
...
$string['unknownbackupexporterror'] = 'Dışa verme için bilgi hazırlarken bilinmeyen hata';

...
/**
 * Strings for component 'local_staticpage', language 'tr', version '3.10'.
 *
...
$string['documentnavbarsource'] = 'Kırpılmış öğe başlığının veri kaynağı';
$string['documentnavbarsource_desc'] = 'Statik sayfanın kırpılmış öğe başlığının veri kaynağı (Moodle "Navbar" da kullanılır)';

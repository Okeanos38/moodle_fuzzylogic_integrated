...
/**
 * Strings for component 'local_amos', language 'tr', version '3.10'.
 *
 * @package     local_amos
 * @category    string
...
$string['about'] = '<p>AMOS, Moodle dizelerinin ve tarihlerinin merkezi bir deposudur. Moodle koduna İngilizce dizelerin eklenmesini izler, çevirileri toplar, ortak çeviri görevlerini işler ve Moodle sunucularında konuşlandırılacak dil paketleri oluşturur.</p>
<p>Daha fazla bilgi için <a href="https://docs.moodle.org/dev/AMOS_manual">AMOS belgelerine</a> bakın.</p>';
$string['amos'] = 'AMOS - Moodle çeviri aracı';
$string['amos:changecontriblang'] = 'Katkıda bulunan dizelerin dilini değiştirin';
$string['amos:commit'] = 'Raflardaki dizeleri ana depoya teslim et';
...
$string['amos:stash'] = 'Şu an rafta bulananları kalıcı ambara depola';
$string['amos:usegoogle'] = 'Google Çeviri servisini kullanın';
$string['applangindexfile'] = 'Moodle Uygulaması langindex dosyası konumu';
$string['applangindexfile_desc'] = 'Dosyanın indirileceği yerin tam URL\'si. Bir cron görevi tarafından yapılacaktır.';
$string['branchesall'] = 'Bilinen tüm Moodle sürümleri';
$string['branchesall_desc'] = 'AMOS\'un desteklediği Moodle sürüm kodlarının virgülle ayrılmış listesi. Bu, çevirmen filtresindeki ve diğer yerlerdeki sürümlerin listesini doldurmak için kullanılır.';
$string['branchsupported'] = 'Desteklenen en eski Moodle sürümü';
$string['branchsupported_desc'] = 'İngilizce dizelerdeki değişiklikler için izlenmesi gereken ve yükleyici dil paketlerinin henüz oluşturulduğu en eski Moodle sürümünün kodu. Referans için <https://docs.moodle.org/dev/Releases#Version_support> adresini kullanın.';
$string['cachedef_lists'] = 'AMOS\'ta bilinen dillerin ve bileşenlerin listeleri';
$string['commitbutton'] = 'Teslim et';
$string['commitkeepstaged'] = 'Dizeler raflandı';
...
$string['committable'] = 'Bu dil paketini taahhüt etme izniniz var';
$string['committableall'] = 'tüm lisanlar';
$string['committablenone'] = 'Kabul edilmiş lisan yok- lütfen AMOS yöneticisine başvurun';
...
$string['contribaccept'] = 'Kabul';
$string['contribactions'] = 'Müşterek çeviri eylemleri';
$string['contribactions_help'] = 'Çeviri iş akışı ve yetkilerineze bağlı olarak, aşağıdaki bölümleri kullanabilirsiniz:
...
$string['contribassigntome'] = 'Bana ata';
$string['contribauthor'] = 'Yazar';
$string['contribclosedno'] = 'Sonuçlanmış teslimatları gizle';
$string['contribclosedyes'] = 'Sonuçlanmış teslimatları göster';
$string['contribcomponents'] = 'Bileşen(ler)';
$string['contribid'] = 'Kimlik';
$string['contribincomingnone'] = 'Gelen teslimat yok';
$string['contribincomingsome'] = 'Gelen teslimat ({$a})';
$string['contriblanguage'] = 'Lisan';
$string['contriblanguagebutton'] = 'Çevir';
$string['contriblanguagechange'] = 'Yanlış katkı dilini düzeltme';
$string['contriblanguagechange_help'] = 'Katkı yanlışlıkla yanlış dil paketine gönderilmişse, aşağıdaki açılır menüden doğru dili seçin ve ardından Dönüştür düğmesini tıklayın.';
...
$string['contriblanguagewrong'] = 'Yanlış Dil?';
...
Katkınız için teşekkürler. Ancak, yanlışlıkla yanlış dil paketine gönderilmiş gibi görünüyor. Böylece katkınız yanlış dil paketinden reddedildi ve dil paketi geliştiricisi tarafından gözden geçirilmek üzere doğru dil paketine taşındı. Sizin herhangi bir işlem yapmanız gerekmez.
...
$string['contribnotifpending'] = 'Dil koordintörü olar  teslim edilen  #{$a->id} {$a->subject} çevirisi için işlem görmeyi gerektiren teslimatlarınız var.

Bir dil koordinatörü olarak size gönderilen teslimatları incelemeniz ve sonucunda kabul veya red olarak işaretlemeniz gerekiyor.
...
---------------------------------------------------------------------
Teslimat sayfası: {$a->contriburl}';
$string['contribnotifsubmitted'] = '$a->fullname} yeni  Çeviri #{$a->id} {$a->subject} teslim etti.
...
$string['contribstaged'] = '<a href="contrib.php?id={$a->id}">#{$a->id}</a>tarafından {$a->author} gönderilen teslimat raflandı.';
...
$string['contribsubmittedsome'] = 'Senin teslimatların  ({$a})';
$string['contribtimemodified'] = 'Değiştirildi';
$string['contribute'] = 'Çeviri';
$string['contributenow'] = 'Çeviriye başla';
...
$string['contributethanks'] = 'Son katkılarından dolayı {$a->listcontributors} \'a çok teşekkür ederiz.';
$string['contributethankslist'] = '';
$string['contributions'] = 'Teslimatlar';
...
$string['creditscontributors'] = 'değer katkıda bulunanlar';
$string['creditsdelcontributor'] = 'Katkıda buluna kişi kaldır';
$string['creditsdelmaintainer'] = 'Koordinatör';
...
$string['filtermisfmis'] = 'sadece eksik ve eski dizeler';
$string['filtermisfout'] = 'yalnızca modası geçmiş dizeler';
$string['filtermisfstg'] = 'sadece raflanmış dizeler';
$string['filtersid'] = 'Dize tanımlayıcı';
$string['filtersid_desc'] = 'Anahtar dizeleri dizisi';
$string['filtersidpartial'] = 'kısmı eşleşme';
$string['filtertxt'] = 'Altdizeler';
$string['filtertxt_desc'] = 'dize girilen metni içermeli';
...
$string['language'] = 'Lisan';
$string['languages'] = 'Lisanlar';
...
$string['logfiltersourceimport'] = 'al (teslimat eklentilerinden alınan dizeler)';
$string['logfiltersourcerevclean'] = '';
...
$string['numofcommitsabovelimit'] = 'En son {$a->limit} kullanılarak, kaydetme filtresiyle eşleşen {$a->found} işlem bulundu';
$string['numofcommitsunderlimit'] = 'Kaydetme filtresiyle eşleşen {$a->found} işlem bulundu';
...
$string['privacy:metadata:db:amoscommits:timecommitted'] = 'Kaydetmenin zaman damgası.';
...
$string['savefilter'] = 'Filtre ayarlarını kaydet';
...
$string['stage'] = 'Raf';
$string['stageactions'] = 'Rafe eylemleri';
...
$string['stagestringsnone'] = 'Raflanan dize yok';
$string['stagestringssome'] = 'Aşamalı {$a-> aşamalı dizeler var, bunlardan {$a->committable} işlenebilir';
...
$string['stageunstageall'] = 'Tümünü raftan al';
...
$string['translatortranslation_help'] = 'Hücre Giriş Düzenleyicisi\'ni açmak için tıklatın. Çeviri ekleyin ve çeviriniki eklemek hücresinin dışında tıklatın. Hücrenin arka plan rengi şu anlama gelir:
...
$string['typecontrib'] = 'Standart olmayan eklentiler';
...
$string['unstageconfirm'] = 'Gerketen mi?';

...
/**
 * Strings for component 'enrol_self', language 'tr', version '3.10'.
 *
 * @package     enrol_self
 * @category    string
...
$string['canntenrol'] = 'Ders kaydı devre dışı veya etkin değil';
...
$string['groupkey_help'] = 'Dersi yalnızca anahtarı tanıyan kişilere sınırlamanın yanı sıra, grup kayıt anahtarlarını kullanmak, kullanıcıların derse kaydolurken otomatik olarak gruplara eklendiği anlamına gelir.

Not: Ders için bir kayıt anahtarı, grup ayarlarındaki kendi kayıt ayarlarında ve grup kayıt anahtarlarında belirtilmelidir.';
...
$string['newenrols'] = 'Yeni kayıtlara izin ver';
$string['newenrols_desc'] = 'Kullanıcıların varsayılan olarak yeni derslere kaydolmalarına izin verin.';
$string['newenrols_help'] = 'Bu ayar, bir kullanıcının bu derse kaydolup giriş yapamayacağını belirler.';
...
$string['pluginname_desc'] = 'Kendi kendine kayıt eklentisi, kullanıcıların hangi derslere katılmak istediklerini seçmelerini sağlar. Dersler bir kayıt anahtarı tarafından korunabilir. Dahili olarak kayıt işlemi, aynı derste etkinleştirilmesi gereken el ile kayıt eklentisi aracılığıyla yapılır.';
$string['requirepassword'] = 'Kayıt anahtarı gerekir';
$string['requirepassword_desc'] = 'Yeni derslerde kayıt anahtarı talep etmek ve mevcut kayıtlardan kayıt anahtarı kaldırılmasını önlemek.';
...
$string['status'] = 'Var olan kayıtlara izin ver';
$string['status_desc'] = 'Yeni kurslarda kendi kendine  kayıt yöntemini etkinleştiriniz.';
$string['status_help'] = '\'Yeni kayıtlara izin ver\' özelliği devre dışı bırakıldığında etkinleştirilirse, daha önce kendi kayıt yaptırmış olan kullanıcılar kursa erişebilir. Devre dışı bırakıldıysa, bu öz kayıt yöntemi etkili bir şekilde devre dışı bırakılır, çünkü varolan tüm öz kayıtlar askıya alınır ve yeni kullanıcılar kendilerini kayıt altına alamaz.';
...
$string['welcometocourse'] = '{$a}\'ya Hoş Geldiniz';

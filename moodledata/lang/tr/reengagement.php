...
/**
 * Strings for component 'reengagement', language 'tr', version '3.10'.
 *
...
$string['emailcontentthirdparty_help'] = 'Modül bir üçüncü taraf e-posta gönderdiğinde, bu alanın e-posta içeriğini alır.';
...
$string['emailsubjectthirdparty_help'] = 'Modül bir üçüncü taraf e-posta gönderdiğinde, e-posta konusu bu alandan alınır.';
$string['emailtime'] = 'E-posta zamanı';
$string['emailuser'] = 'E-posta kullanıcısı';
$string['emailuser_help'] = 'Etkinlik kullanıcılara e-posta ile gönderilmelidir: <ul>
<li> Asla: Kullanıcılara e-posta gönderme. </ li>
<li> Yeniden başlatma tamamlandığında: Yeniden düzenleme etkinliği tamamlandığında kullanıcıyı e-postayla gönderin. </ li>
<li> Gecikmeden Sonra: Modülü başlattıktan sonra kullanıcıya belirli bir süre e-postayla gönderin. </ li>
</ ul>';
...
$string['thirdpartyemails_help'] = 'Kullanıcı yaptığında bir e-posta alması gereken üçüncü tarafların e-posta adreslerinin virgülle ayrılmış bir listesi.';

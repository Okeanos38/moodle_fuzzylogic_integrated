...
/**
 * Strings for component 'enrol_manual', language 'tr', version '3.10'.
 *
...
Bu \'{$a->course}\' dersindeki kaydınızın {$a->timeend} tarihinde sona ereceğini belirten bir bildirimdir.

Yardıma ihtiyacınız varsa, lütfen {$a->enroller} ile iletişime geçin.';
$string['expirymessageenrolledsubject'] = 'Kayıt son bildirimi';
$string['expirymessageenrollerbody'] = 'Aşağıdaki kullanıcıların \'{$a->course}\' dersine kayıtları {$a->threshold} tarihinde sona erecektir.
...
$string['wsusercannotassign'] = 'Bu rolü atamak için izniniz yok ({$a->roleid}) bu kullanıcıya ({$a->userid}) bu derste ({$a->courseid}).';

...
/**
 * Strings for component 'qformat_wordtable', language 'tr', version '3.10'.
 *
...
$string['export_type_set'] = 'Soru dışa aktarma türü için ayarlandı';
...
$string['tempfile'] = 'Geçici XML dosyası: <b>{$a}</b>';
$string['templateunavailable'] = 'Word uyumlu XHTML şablonu <b>{$a}</ b> kullanılamıyor';
...
$string['word_conversionfailed'] = 'Soru içe aktarma başarısız';
$string['word_conversionsucceeded'] = 'Soru içe aktarma <b>başarılı oldu</ b>, devam etmek için <b> \'Kapat\' </ b> düğmesini tıklayın.';
$string['word_conversionsucceeded2'] = 'Soru içe aktarma <b>başarılı</ b>, <br> Devam etmek için "Devam" düğmesine tıklayın.';
$string['word_convert_images'] = 'Resimleri Dönüştür';
$string['word_convert_images_screentip'] = 'Dışa aktarılan sorudaki resim verilerini içe aktarma';
$string['word_convert_images_supertip'] = 'Görüntüleri Word dosyasına göm';
$string['word_currentquestion'] = '(Güncel Soru)';
$string['word_import_mathtype'] = 'MathType Resimlerini İçe Aktar';
$string['word_import_mathtype_screentip'] = 'MathType Denklem görüntülerini içe aktar';
$string['word_import_mathtype_supertip'] = 'MathType \'Denklemleri Dışa Aktar\' komutundan sonra çalıştır';
$string['word_import_screentip'] = 'Yüklemek ve tüm soruları Moodle sunucunuza aktarmak';
$string['word_login_supertip'] = 'Kendi Moodle sunucunuzu seçin';
...
$string['word_preview'] = 'Mevcut Soruyu Önizle';
$string['word_preview_supertip'] = 'İmleç bir tablonun içinde olmalıdır';
$string['word_setunset_assessment_screentip'] = 'Basılı bir değerlendirme için yeniden biçimlendirme soruları';
$string['word_setunset_assessment_supertip'] = 'Soru meta verilerini (ad, doğru yanıt göstergeleri, geribildirim vb.) Gizli olarak ayarlayın';

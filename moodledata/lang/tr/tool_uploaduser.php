...
/**
 * Strings for component 'tool_uploaduser', language 'tr', version '3.10'.
 *
...
$string['uploadusers_help'] = 'Kullanıcılar metin dosyası aracılığıya yüklenebilir (ve isteğe bağlı olarak kurslarına kayıt yapılabilir). Dosyanın biçimi aşağıdaki şekilde olmalıdır: * Her satırı bir kayıt içermeli. * Her kayıt verisi virgülle (veya diğer sınırlayıcılar) tarafından ayrılmış bir dizi) olmalı * İlk kayıttan son kayda kadar tanımlanmış alanadı listesini içermelidir. * Gerekli alanadları: kullanıcı adı, şifre, ad, soyad, e-posta dır.';

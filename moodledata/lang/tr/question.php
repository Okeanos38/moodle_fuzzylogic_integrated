...
/**
 * Strings for component 'question', language 'tr', version '3.10'.
 *
 * @package     question
 * @category    string
...
$string['action'] = 'Eylem';
$string['addanotherhint'] = 'Bir başka ipucu daha ekleyin';
$string['addcategory'] = 'Kategori ekleyin';
...
$string['attemptfinishedsubmitting'] = 'Tamamlanmış gönderiyi göndermeyi dene';
$string['attemptoptions'] = 'Gönderim seçenekleri';
...
$string['deletequestioncheck'] = 'Şunu silmek istediğinize emin misiniz  \'{$a}\'?';
$string['deletequestionscheck'] = 'Aşağıdaki soruları silmek istediğinizden kesinlikle emin misiniz? < br / > < br / > {$a}';
...
* Kurs kategori içeriği - sorular  Kurs kategorisindeki tüm etkinlik modülleri ve derslerde kullanılabilir.
...
$string['erroritemappearsmorethanoncewithdifferentweight'] = 'Soru ({$a}), farklı pozisyonlarda test farklı ağırlıklar ile birden çok kez görüntüleniyor. Bu durum istatisti raporu tarafından şu anda desteklenmiyor ve bu soru için istatistikleri güvenilmez hale getirebilir.';
...
$string['fillincorrect'] = 'Doğru yanıtları doldur';
...
$string['invalidanswer'] = 'Tamamlanmamış cevap';
...
$string['mark'] = 'Not';
$string['markedoutof'] = 'Dışarda olarak işaretle';
$string['markedoutofmax'] = '{$a} üzerinden işaretlenmiş';
...
$string['notchanged'] = 'Son gönderimden beri hiç değiştirilmedi';
...
$string['penaltyforeachincorrecttry_help'] = '\'Etkileşimli çoklu deneme\' veya \'Uyarlamalı mod\' da sorularla çalışırken öğrenci doğru cevabı bulmak için birkaç deneme yapacaktır, bu seçenek her yanlış cevaba ne kadar ceza uygulayacağınızı kontrol edebilirsiniz.
Ceza toplam puanın bir oranıdır, eğer sorunuzun toplam puanı 3 ise ceza puanı 0.3333333, dür öğrenci ilk seferinde doğru cevaplarsa 3, ikincisinde doğru cevaplarsa 2 ve üçüncüsünde doğru cevaplarsa 1 puan alacaktır.';
...
$string['questionbehavioursdisabledexplained'] = 'Hedeflerin açılan kutuda görünmesi için listeyi virgülle ayırarak giriniz.';
$string['questionbehavioursorder'] = 'Soru davranışına göre sıralama';
$string['questionbehavioursorderexplained'] = 'Hedeflerin açılan kutuda görünmesi için listeyi virgülle ayırarak giriniz.';
...
$string['questionsinuse'] = '(* Yıldız ile işaretlenmiş sorular halen bazı sınavlarda kullanılmaktadır.Bu soru bu sınavlardan değil, sadece kategori listesinden silinmez.)';
...
$string['requiresgrading'] = 'Notlandırma gerekir';
$string['responsehistory'] = 'Cevap geçmişi';
$string['restart'] = 'Yeniden başla';
$string['restartwiththeseoptions'] = 'Bu ayarlarla yeniden başla';
$string['reviewresponse'] = 'Yanıtı incele';
$string['rightanswer'] = 'Doğru cevap';
$string['rightanswer_help'] = 'doğru yanıtın otomatik olarak oluşturulan bir Özeti.
Bu sınırlı olabilir, bu soru için doğru çözümünü açıklayan genel geribildirim göndermeyi düşünebilirsiniz, ve bu seçeneği kapatmayı deneyin.';
$string['save'] = 'Kaydet';
...
$string['showmarkandmax'] = 'Maksimumu ve notu göster';
$string['showmaxmarkonly'] = 'Yalnızca maksimum notu göster';
...
$string['technicalinfomaxfraction'] = 'Maksimum fraksiyon: {$a}';
$string['technicalinfominfraction'] = 'Minimum fraksiyon: {$a}';
$string['technicalinfoquestionsummary'] = 'Soru özeti: {$a}';
$string['technicalinforesponsesummary'] = 'Yanıt özeti: {$a}';
$string['technicalinforightsummary'] = 'Doğru cevap özeti: {$a}';
$string['technicalinfostate'] = 'Soru durumu: {$a}';
$string['technicalinfovariant'] = 'Soru değişkeni: {$a}';

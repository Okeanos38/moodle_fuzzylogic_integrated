...
/**
 * Strings for component 'local_sandbox', language 'tr', version '3.10'.
 *
...
$string['adjustcoursestartdate'] = 'Dersin başlangıç tarihini ayarla';
$string['adjustcoursestartdate_desc'] = 'Dersin yedekleme dosyasında kaydedilen tarihe ayarlamak yerine, ders başlangıç tarihini bugüne ayarlayın.';
$string['coursebackups'] = 'Ders yedeklemeleri
 ';
$string['coursebackups_desc'] = 'Dersi geri yüklemek için kullanmak üzere ders yedekleme dosyalarını içeren .mbz dosyalarını buraya yükleyin. Bu dosya alanındaki ders yedekleme dosyaları, uygun ders kısa adıyla adlandırılmalı ve .mbz dosya adı uzantısına sahip olmalıdır. Ayrıntılar için README dosyasına bakın.';
$string['coursebackupsheading'] = 'Ders yedeklemeleri';
...
$string['eventcourserestored_desc'] = '\'{$a}\' Dersi önceden tanımlanmış ders durumuna geri yüklendi';
...
$string['skippingadjuststartdatefailed'] = 'UYARI: Ders "{$a}" ders başlangıç tarihi ayarlamasında başarısız oldu, dosya atlandı ...';
$string['skippingcreatefailed'] = 'UYARI: Ders "{$a}" oluşturulma sırasında başarısız oldu, dosya atlandı ,...';
...
$string['skippingrestorefailed'] = 'UYARI: Dersin geri yüklenmesi "{$a}" dersi başarısız oldu, dosyayı atlandı ...';
$string['skippingunzipfailed'] = 'UYARI: "{$a}" yedek dosyasının sıkıştırılmaması başarısız oldu, dosyayı atlandı ...';
$string['successrestored'] = 'BAŞARI: Dersler geri yüklendi "{$a}" ';
...
$string['upgrade_notice_2018020902'] = '<strong>YÜKSELTME BİLDİRİMİ:</strong> Ders yedekleme dosyaları Moodle içindeki yeni dosya alanına taşındı. Eski ders yedekleri dizinini {$a} şimdi silebilirsiniz. Daha fazla yükseltme talimatı için README dosyasına bakın.';

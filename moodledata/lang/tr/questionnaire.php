...
/**
 * Strings for component 'questionnaire', language 'tr', version '3.10'.
 *
...
$string['answer'] = 'Cevap';
$string['answergiven'] = 'Cevaplanan';
$string['answernotgiven'] = 'Cevaplanmayan';
...
$string['closedate'] = 'Kapanma tarihini kullanın';
...
$string['dateformatting'] = 'Gün / ay / yıl formatını kullanın,  Örneğin 14 Mart 1945:&nbsp;  için <strong>14/3/1945</strong>';
...
$string['downloadtextformat'] = 'Metin biçiminde indir';
$string['downloadtextformat_help'] = 'Bu özellik, bir metin dosyasına (CSV) bir anketin tüm yanıtları kaydetmenizi sağlar. Bu dosyayı daha sonra bir tablo (örneğin MS Excel veya Open Office Calc) veya daha fazla veri işlemek için bir istatistik paket içine alınabilir.';
...
$string['event_resumed'] = 'Girişimi yeniden başladı';
...
$string['feedbackmessages'] = 'Bölüm {$a} için geri bildirim mesajları';
...
$string['feedbacksectionheading'] = 'Bölüm {$a} için geri bildirim başlığı';
...
$string['feedbacksections'] = '{$a} bölümü geribildirimi';
...
$string['incorrectmodule'] = 'Ders Modülü Kimliği yanlıştır';
$string['incorrectquestionnaire'] = 'Anket yanlışdir';
$string['invalidresponse'] = 'Geçersiz cevap seçildi';
$string['invalidresponserecord'] = 'Geçersiz cevap yadı seçildi';
...
$string['mandatory'] = 'Zorunlu - Tüm ön koşullar yerine getirilmelidir.';
$string['maxdigitsallowed'] = 'Max. izin verilen basamak';
$string['maxdigitsallowed_help'] = 'Max kullanarak. izin verilen basamak ve Nb ondalık basamaklı parametreleri belirleyebilirsiniz
uzunluk ve ondalık basamak sayısı gereklidir.';
...
$string['minforcedresponses_help'] = '';
...
$string['missingquestion'] = 'Lütfen zorunlu olan soruya cevap verin';
$string['missingquestions'] = 'Please answer Required question:';
$string['missingrequired'] = '{$A} soru olamaz bu gerekli değildir, çünkü bu geri bildirim bölümünde kullanılabilir.';
...
$string['of'] = 'den';
$string['opendate'] = 'Başlangıç tarihini kullan';
$string['option'] = '{$a} seçeneği';
$string['optional'] = 'Tercihen - En az bir koşulun yerine getirilmiş olması gerekir.';
...
$string['responsefieldlines'] = 'Giriş kusutu boyu';
...
$string['sendemail_help'] = 'Belirtilen adrese veya adreslere gönderinin bir kopyasını gönderir.
Virgül ile ayırarak, birden çok adresi ekleyebilirsiniz.
e-posta yedeklemesi yapmayacaksanız, için boş bırakın.';
$string['set'] = 'ayarla';
...
$string['textdownloadoptions'] = 'Metin olarak indirmek için Seçenekler (CSV)';
...
$string['viewyourresponses'] = 'Sizin cevaplarınız- görüntüle {$a}';
...
$string['yourresponse'] = 'Cevaplarınız';
$string['yourresponses'] = 'Cevaplarınız';

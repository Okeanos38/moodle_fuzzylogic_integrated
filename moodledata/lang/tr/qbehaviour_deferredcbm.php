...
/**
 * Strings for component 'qbehaviour_deferredcbm', language 'tr', version '3.10'.
 *
...
$string['cbmgrades_help'] = 'Kesinliğe Dayalı İşaretleme (CBM) ile C = 1 (düşük kesinlik) ile her sorunun doğru olması,% 100 derecesini verir. Her soru C = 3 ile doğruysa, notlar% 300 gibi yüksek olabilir (yüksek kesinlik). Yanılgılar (kendine güvenen yanlış cevaplar) belirsiz olduğu kabul edilen yanlış cevaplardan çok daha düşük notlar verir. Bu bile olumsuz genel notlara neden olabilir.
...
$string['certainty_help'] = 'Kesinliğe dayalı işaretleme, cevabınızın ne kadar güvenilir olduğunu belirtmenizi gerektirir. Mevcut düzeyler şunlardır:

Belirginlik
 düzeyi     | C = 1 (Emin değilim) | C = 2 (Ortada) | C = 3 (Kesinlikle)
--------------| ---------------------------   | ---------------------| ----------------
Eğer doğruysa
işaretle      | 1                                  | 2                       | 3
Yanlış
işaretliyse  |  0                                 | -2                      | -6
Doğruluk
olasılıkları   |  <67%                         | 67-80%      |    >80%
Belirsizliği kabul ederek en iyi notlar elde edilir. Örneğin, yanlış olma şansının 3\'te 1\'den fazla olduğunu düşünüyorsanız, C = 1 girmeli ve negatif işaret riskinden kaçınmalısınız.';
